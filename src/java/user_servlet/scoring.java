 ...
 * The previous results of the user is shown here.
 */
public class scoring extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (conn == null) {
                request.getSession().setAttribute("message", "servlet for process");
            }
            if (conn != null) {
                request.getSession().setAttribute("message", "servleting connecting for process");
            }
              request.getSession().setAttribute("message", "connecting for process");
